    ...
    return (
      ...
      <div className="p-4">
        ...
        <div className="relative p-8 overflow-hidden" style={{ minHeight: '60rem' }}>
            ...
            <img src="assets/images/hero-2.jpg" alt="hero-2" className="absolute top-0 left-0 w-auto h-full block md:w-full" />
        ...
        <div className="px-4 py-8 md:px-6 lg:px-8" style={{ background: 'radial-gradient(69.84% 69.84% at 50% 100%, rgba(21, 101, 192, 0.15) 0%, rgba(255, 255, 255, 0) 100%)' }}>
          <div className="text-blue-600 font-medium mb-3">ALL-IN-ONE</div>
          <div className="text-900 text-2xl font-bold mb-3">Focus on the work that matters</div>
          <div className="text-700 text-sm">Ac turpis egestas maecenas pharetra convallis posuere morbi leo urna.</div>
          <div className="grid mt-7">
              <div className="col-12 md:col-4">
                  <div className="shadow-1 p-5 surface-card text-center">
                      ...
                      <div className="text-900 font-medium text-xl mb-4">Simpler Interface</div>
                      <div className="text-700 text-sm mb-4 line-height-3">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</div>
              ...
              <div className="col-12 md:col-4">
                  <div className="shadow-1 p-5 surface-card text-center">
                      ...
                      <div className="text-900 font-medium text-xl mb-4">Extensive Connectivity</div>
                      <div className="text-700 text-sm mb-4 line-height-3">Risus nec feugiat in fermentum posuere urna nec. Posuere sollicitudin aliquam ultrices sagittis.</div>
                      <Button label="Learn More" className="p-button-text font-bold" />
                  </div>
              </div>
              <div className="col-12 md:col-4">
